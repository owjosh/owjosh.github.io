    ...
    init: function(editor) {
        ...
        editor.widgets.add('z-preview-init', {
            ...
            data: function() {
                ...
                this.element.append('<script>$(document).ready(function(){$("#posterViewer").append(\'<iframe src="https://themes.secure-platform.com/ViewerJS/#{SubmissionForm.poster.MediaUrl}" width="600" height="400" allowfullscreen webkitallowfullscreen></iframe>\');});</script>');
            }
        });
